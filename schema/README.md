...
Discovery document published at `/.well-known/cq-node.json` by a cq node. See the [Node Discovery Protocol]({{REPO_TREE_URL}}/docs/node-discovery-protocol.md) for the full specification.
