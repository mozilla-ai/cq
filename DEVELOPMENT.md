...
See [Install into your coding agent](install.md) for installing cq into Claude, Codex, Copilot, Cursor, Devin Desktop, OpenCode, or Pi — including per-host config paths and how to point an agent at a remote server.
